...
import com.example.onlinelearning.databinding.OngoingCourseItemBinding
...
class OngoingCourseAdapter: RecyclerView.Adapter<OngoingCourseAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: OngoingCourseItemBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = OngoingCourseItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
